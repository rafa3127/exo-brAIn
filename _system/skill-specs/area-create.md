...
|------|----------|---------|
| `project` | Professional work, deliverables, codebases | Prosight UI, SinapsAI, BalanceBook |
...
1. Gather from user:
   ...
   - `path`: vault path (e.g., `work/prosight-ui`, `university/data-structures`, `knowledge/typescript`)
...
- Sub-areas (e.g., `work/prosight-ui/auth-module`) use this same skill with the full path.
